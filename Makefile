...
default_report:
	...
	g++ -std=c++11 -Wall -Wextra -Werror -g -I. tests/*.c++ tests/reporters/default.c++ -o tests/reporters/default_run
...
TAP_report:
	...
	g++ -std=c++11 -Wall -Wextra -Werror -g -I. tests/*.c++ tests/reporters/TAP.c++ -o tests/reporters/TAP_run
