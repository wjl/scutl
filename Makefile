...
default_report:
	...
	g++ -std=c++98 -Wall -Wextra -Werror -g -I. $(sort $(wildcard tests/*.c++)) tests/reporters/default.c++ -o tests/reporters/default_run
...
TAP_report:
	...
	g++ -std=c++98 -Wall -Wextra -Werror -g -I. $(sort $(wildcard tests/*.c++)) tests/reporters/TAP.c++ -o tests/reporters/TAP_run
